...
**M1 実装中 — F3・F4 完了。F5前半（T-24〜T-30のうちT-29除く）完了: T-25/T-26/T-27/T-28/T-30（いずれもランタイムAPI呼び出しをせずエージェントが直接データ構築。🟡人間目視確認は4件とも未実施）。次はT-29（key単語類題生成）だがレビュー未完了のkeyVocabが入力のため実質保留、または人間レビューを待つ。** タスク進捗: 29 / 38 完了。
...
| F5 コンテンツパイプライン（T-24〜T-34) | 🔶 一部完了 | T-24・T-25・T-26・T-27・T-28・T-30 完了。T-29は依存（レビュー済みkeyVocab）待ちで実質保留。TTS（T-31）はB-2未解決で引き続きブロック。**M1 全体の律速** |
