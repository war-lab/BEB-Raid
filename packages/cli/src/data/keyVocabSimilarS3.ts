...
export const KEY_VOCAB_SIMILAR_S3_RAW: KeyVocabSimilarS3RawEntry[] = [
  ...
  },
  {
    ...
    explanation:
      '役職廃止に伴う「人員整理」はredundancy。recall（製品回収）・liquidation（会社清算）・embargo（禁輸措置）はいずれも人員に関する語ではなく、この文脈に合わない。',
  ...
  },
  {
    ...
    explanation:
      '組織全体の規模を縮小する「人員削減」はdownsizing。moratorium（一時停止措置）・audit（監査）・embargo（禁輸措置）はいずれも人員削減とは異なる意味で、この文脈に合わない。',
