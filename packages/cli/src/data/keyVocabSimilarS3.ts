...
export const KEY_VOCAB_SIMILAR_S3_RAW: KeyVocabSimilarS3RawEntry[] = [
  ...
  },
  {
    ...
    explanation:
      '建物・敷地全体を指す「構内」はpremises。showroom（展示室）・warehouse（倉庫）・venue（会場）はこの文脈では代わりにくい。',
  ...
  },
  {
    word: 'consolidation',
    tags: ['ビジネス名詞'],
    question: 'The merger led to significant operational ___ across both companies within a year.',
    correctText: 'consolidation',
    distractors: ['recall', 'liquidation', 'embargo'],
    explanation:
      '複数拠点の業務を一つにまとめる「統合」はconsolidation。recall（製品回収）・liquidation（会社清算）・embargo（禁輸措置）はいずれも業務統合とは異なる意味で、この文脈に合わない。',
    translation: 'その合併は、1年以内に両社にわたる大幅な業務統合につながった。',
    difficulty: 4,
  },
  {
    word: 'renovation',
    ...
    correctText: 'renovation',
    distractors: ['moratorium', 'audit', 'embargo'],
    explanation:
      '複数の拠点にまたがる改修は renovation。moratorium（一時停止措置）・audit（監査）・embargo（禁輸措置）はいずれも改修とは異なる意味で、この文脈に合わない。',
    translation: 'その会社は、複数の拠点に影響する大規模な改修計画を発表した。',
    difficulty: 4,
  },
  {
    word: 'nonrefundable',
