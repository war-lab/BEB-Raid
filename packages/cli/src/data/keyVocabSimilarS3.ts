...
export const KEY_VOCAB_SIMILAR_S3_RAW: KeyVocabSimilarS3RawEntry[] = [
  ...
  },
  {
    word: 'condemnation',
    tags: ['ビジネス名詞'],
    question: 'The old building received a ___ notice from the city inspector last week.',
    correctText: 'condemnation',
    distractors: ['infringement', 'acquittal', 'regulation'],
    explanation:
      '建物等の使用不可を宣告する「使用不可宣告」はcondemnation。infringement（侵害）・acquittal（無罪判決）・regulation（規制）はこの通知の内容を意味しない。',
    translation: 'その古い建物は、先週市の検査官から使用不可宣告の通知を受けた。',
    difficulty: 4,
  },
  {
    word: 'acquittal',
    tags: ['ビジネス名詞'],
    question:
      'The jury reached an ___ after a surprisingly short deliberation that lasted less than an hour.',
    correctText: 'acquittal',
    distractors: ['condemnation', 'infringement', 'dispute'],
    explanation:
      '裁判での「無罪判決」はacquittal。condemnation（使用不可宣告）・infringement（侵害）・dispute（紛争）は判決の結果を意味しない。',
    translation: '陪審は1時間足らずという驚くほど短い協議の後、無罪判決に達した。',
    difficulty: 4,
  },
  {
    word: 'redundancy',
