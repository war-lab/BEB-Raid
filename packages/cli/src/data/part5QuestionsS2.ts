...
export const PART5_ENTRIES_S2_RAW: Part5RawEntry[] = [
  ...
  },
  {
    ...
    distractors: ['confidential', 'proprietary', 'compliantly'],
    explanation:
      '空所はbe動詞areの補語となる形容詞。compliantが正しい。confidential（機密の）・proprietary（独自の）は形容詞だが意味が合わず、compliantlyは副詞で補語の位置には合わない。',
  ...
  },
  {
    ...
    tags: ['動詞の形'],
    question: 'The company decided to ___ its manufacturing to an overseas facility.',
    correctText: 'outsource',
    distractors: ['outsourced', 'outsourcing', 'outsources'],
    explanation:
      'to不定詞の後は動詞の原形が続くため、outsourceが正しい。他の3つは活用形で、to不定詞の形に合わない。',
    translation: 'その会社は製造を海外の施設へ委託することを決めた。',
    difficulty: 3,
  },
  {
  ...
  // --- 代名詞・関係詞（関係代名詞who/whom/whose/whichの選択） ---
  {
    ...
    correctText: 'who',
    distractors: ['which', 'whom', 'when'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞raisedが続く）。whichは物を指す関係代名詞、whomは目的格、whenは時を指す関係副詞で、いずれも人物の主格には使えない。',
  ...
  },
  {
    ...
    tags: ['代名詞・関係詞'],
    question: 'The employee ___ the supervisor promoted will start the new role next month.',
    correctText: 'whom',
    distractors: ['which', 'where', 'whoever'],
    explanation:
      '目的格の関係代名詞whomが正しい（the supervisor promotedのpromotedの目的語）。whichは物を指す関係代名詞、whereは場所を指す関係副詞、whoeverは不特定の人物を指す語で、いずれも合わない。',
    translation: '上司が昇進させたその従業員は来月から新しい役職を始める。',
    difficulty: 4,
  },
  {
    ...
    correctText: 'whose',
    distractors: ['which', 'when', 'whoever'],
    explanation:
      '所有格の関係代名詞whoseが正しい（後ろにproperty=名詞が続き所有関係を示す）。whichは物を指す関係代名詞、whenは時を指す関係副詞、whoeverは不特定の人物を指す語で、いずれも所有関係を表せない。',
  ...
  },
  {
    ...
    correctText: 'who',
    distractors: ['which', 'whom', 'whoever'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞submittedが続く）。whichは物を指し、whomは目的格、whoeverは不特定の人物を指す語で特定のapplicantを指す先行詞には合わない。',
  ...
  },
  {
    ...
    explanation:
      '所有格の関係代名詞whoseが正しい（後ろにteam=名詞が続き所有関係を示す）。whichは物を指す関係代名詞、whoは人物を直接指す主格、whenは時を指す関係副詞で、いずれも所有関係を表せない。',
  ...
  },
  {
    ...
    tags: ['代名詞・関係詞'],
    question: 'The liaison ___ submitted the request withdrew it the next day.',
    correctText: 'who',
    distractors: ['which', 'whose', 'whoever'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞submittedが続く）。whichは物を指し、whoseは所有格、whoeverは不特定の人物を指す語で特定のliaisonを指す先行詞には合わない。',
    translation: 'その依頼を提出した連絡担当者は翌日に依頼を取り下げた。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'mentor',
    tags: ['代名詞・関係詞'],
    question: 'The mentor ___ the manager selected left the program early.',
    correctText: 'whom',
    distractors: ['which', 'when', 'whoever'],
    explanation:
      '目的格の関係代名詞whom（口語ではwhoも可）が正しい（the manager selectedのselectedの目的語）。whichは物を指し、whenは関係副詞、whoeverは不特定の人物を指す語で、いずれも合わない。',
    translation: 'マネージャーが選んだメンターはプログラムを早期に離れた。',
    difficulty: 4,
  },
  {
    ...
    correctText: 'who',
    distractors: ['which', 'when', 'where'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞attendedが続く）。whichは物を指し、when/whereはそれぞれ時・場所を指す関係副詞で、いずれも人物の主格には使えない。',
  ...
  },
  {
    ...
    distractors: ['which', 'whom', 'when'],
    explanation:
      '所有格の関係代名詞whoseが正しい（後ろにlogo=名詞が続き所有関係を示す）。whichは物を指す関係代名詞、whomは目的格、whenは時を指す関係副詞で、いずれも所有関係を表せない。',
  ...
  },
  {
    ...
    correctText: 'whom',
    distractors: ['whose', 'where', 'whoever'],
    explanation:
      '目的格の関係代名詞whom（口語ではwhoも可）が正しい（we interviewedのinterviewedの目的語）。whoseは所有格、whereは場所を指す関係副詞、whoeverは不特定の人物を指す語で、いずれも合わない。',
  ...
  },
  {
    ...
    distractors: ['which', 'whom', 'whoever'],
    explanation:
      '所有格の関係代名詞whoseが正しい（後ろにRSVP=名詞が続き所有関係を示す）。whichは物を指す関係代名詞、whomは目的格、whoeverは不特定の人物を指す語で所有関係を表せない。',
  ...
  },
  {
    ...
    correctText: 'who',
    distractors: ['whom', 'whose', 'when'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞openedが続く）。whomは目的格、whoseは所有格、whenは時を指す関係副詞で、いずれも主格の位置には使えない。',
  ...
  },
  {
    ...
    distractors: ['which', 'where', 'whoever'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞manageが続く。personnelは人を表す集合名詞）。whichは物を指し、whereは場所を指す関係副詞、whoeverは不特定の人物を指す語で、いずれも人物の主格には使えない。',
  ...
  },
  {
    ...
    correctText: 'which',
    distractors: ['who', 'when', 'whoever'],
    explanation:
      '先行詞headcount increase（物・事柄）を受ける主格の関係代名詞whichが正しい。who/whoeverは人物を指す語、whenは時を指す関係副詞で、いずれも物を先行詞にする主格には使えない。',
  ...
  },
  {
    ...
    correctText: 'which',
    distractors: ['whom', 'where', 'when'],
    explanation:
      '先行詞subsidiary（物・組織）を受ける主格の関係代名詞whichが正しい（後ろに動詞wasが続く）。whomは目的格、where/whenはそれぞれ場所・時を指す関係副詞で、いずれも物を先行詞にする主格には使えない。',
  ...
  },
  {
    ...
    distractors: ['whose', 'where', 'whoever'],
    explanation:
      '先行詞retailer（組織・企業）を受ける主格の関係代名詞whichが正しい（後ろに動詞dominatesが続く）。whoseは所有格、whereは場所を指す関係副詞、whoeverは不特定の人物を指す語で、いずれも主格の位置には使えない。',
  ...
  },
  {
    ...
    correctText: 'whose',
    distractors: ['which', 'where', 'when'],
    explanation:
      '所有格の関係代名詞whoseが正しい（後ろにprices=名詞が続き所有関係を示す。whoseは人・物どちらにも使える）。whichは所有関係を単独では表せず、where/whenはそれぞれ場所・時を指す関係副詞で、いずれも合わない。',
  ...
  // --- 接続詞vs前置詞（because/because of・although/despite・since/due to等） ---
  {
    ...
    correctText: 'because',
    distractors: ['due to', 'despite', 'unless'],
    explanation:
      '空所の後は節（the deficit continued to grow）なので接続詞becauseが正しい。due toは名詞句が必要な前置詞、despiteは意味が逆（〜にもかかわらず）、unlessは条件（〜しない限り）で文意に合わない。',
  ...
  },
  {
    ...
    correctText: 'because',
    distractors: ['because of', 'in spite of', 'although'],
    explanation:
      '空所の後は節（it had a budget surplus）なので接続詞becauseが正しい。because of/in spite ofは名詞句が必要な前置詞、althoughは意味が逆（〜にもかかわらず）で合わない。',
  ...
  },
  {
    ...
    correctText: 'due to',
    distractors: ['despite', 'since', 'even though'],
    explanation:
      '空所の後は名詞句（air traffic congestion）なので前置詞due toが正しい。despiteは意味が逆で名詞句には合うが文意が反転する。since/even thoughは後ろに節が必要な接続詞で、名詞句には合わない。',
  ...
  },
  {
    ...
    correctText: 'because',
    distractors: ['owing to', 'despite', 'even though'],
    explanation:
      '空所の後は節（the consignment lacked...）なので接続詞becauseが正しい。owing toは名詞句が必要な前置詞、despite/even thoughは意味が逆（〜にもかかわらず）で合わない。',
  ...
  },
  {
    ...
    correctText: 'because',
    distractors: ['on account of', 'in spite of', 'unless'],
    explanation:
      '空所の後は節（the shipment arrived...）なので接続詞becauseが正しい。on account ofは名詞句が必要な前置詞、in spite ofは意味が逆、unlessは条件で文意に合わない。',
  ...
  },
  {
    ...
    correctText: 'because of',
    distractors: ['despite', 'because', 'even though'],
    explanation:
      '空所の後は名詞句（high overhead costs...）なので前置詞because ofが正しい。despiteは意味が逆で文意が反転する。because/even thoughは後ろに節が必要な接続詞で、名詞句には合わない。',
  ...
  },
  {
    ...
    correctText: 'because of',
    distractors: ['in spite of', 'since', 'unless'],
    explanation:
      '空所の後は名詞句（the new tariff）なので前置詞because ofが正しい。in spite ofは意味が逆で文意が反転する。since/unlessは後ろに節が必要な接続詞で、名詞句には合わない。',
  ...
  },
  {
    keyVocabWord: 'levy',
    tags: ['接続詞vs前置詞'],
    question: 'Businesses adjusted their prices ___ the city introduced a new levy.',
    correctText: 'because',
    distractors: ['notwithstanding', 'due to', 'although'],
    explanation:
      '空所の後は節（the city introduced...）なので接続詞becauseが正しい。notwithstanding/due toは名詞句が必要な前置詞、althoughは意味が逆で合わない。',
    translation: '市が新しい課税を導入したため、企業各社は価格を調整した。',
    difficulty: 3,
  },
  {
  ...
  },
  {
    ...
    tags: ['接続詞vs前置詞'],
    question: 'The project was delayed ___ evidence of poor oversight.',
    correctText: 'because of',
    distractors: ['notwithstanding', 'as', 'although'],
    explanation:
      '空所の後は名詞句（evidence of poor oversight）なので前置詞because ofが正しい。notwithstandingは意味が逆で文意が反転する。as/althoughは後ろに節が必要な接続詞で、名詞句には合わない。',
    translation: '管理不足の証拠のため、そのプロジェクトは遅延した。',
    difficulty: 3,
  },
  {
    ...
    correctText: 'due to',
    distractors: ['in spite of', 'as', 'unless'],
    explanation:
      '空所の後は名詞句（ongoing litigation）なので前置詞due toが正しい。in spite ofは意味が逆で文意が反転する。as/unlessは後ろに節が必要な接続詞で、名詞句には合わない。',
    translation: '進行中の訴訟のため、その合併は延期された。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'diversification',
    tags: ['接続詞vs前置詞'],
    question: 'The bank approved additional credit ___ the company pursued diversification.',
    correctText: 'because',
    distractors: ['because of', 'owing to', 'unless'],
    explanation:
      '空所の後は節（the company pursued...）なので接続詞becauseが正しい。because of/owing toは名詞句が必要な前置詞、unlessは条件で文意に合わない。',
    translation: 'その会社が事業の多角化を進めたため、銀行は追加融資を承認した。',
    difficulty: 4,
  },
  {
    keyVocabWord: 'consolidation',
    tags: ['接続詞vs前置詞'],
    question: 'The chain closed several stores ___ it completed a consolidation.',
    correctText: 'because',
    distractors: ['despite', 'on account of', 'even though'],
    explanation:
      '空所の後は節（it completed a consolidation）なので接続詞becauseが正しい。on account ofは名詞句が必要な前置詞、despite/even thoughは意味が逆で合わない。',
    translation: '統合を完了したため、そのチェーン店はいくつかの店舗を閉鎖した。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'renovation',
    tags: ['接続詞vs前置詞'],
    question: "The family moved out temporarily ___ the building's renovation.",
    correctText: 'because of',
    distractors: ['despite', 'since', 'unless'],
    explanation:
      "空所の後は名詞句（the building's renovation）なので前置詞because ofが正しい。despiteは意味が逆で文意が反転する。since/unlessは後ろに節が必要な接続詞で、名詞句には合わない。",
    translation: '建物の改装のため、その家族は一時的に自宅を離れた。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'defect',
    tags: ['接続詞vs前置詞'],
    question: 'The company issued a recall ___ a manufacturing defect.',
    correctText: 'due to',
    distractors: ['notwithstanding', 'although', 'since'],
    explanation:
      '空所の後は名詞句（a manufacturing defect）なので前置詞due toが正しい。notwithstandingは意味が逆で文意が反転する。although/sinceは後ろに節が必要な接続詞で、名詞句には合わない。',
    translation: '製造上の欠陥のため、その会社はリコールを実施した。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'audit',
    tags: ['接続詞vs前置詞'],
    question: 'The department revised its procedures ___ a critical audit finding was made public.',
    correctText: 'because',
    distractors: ['in spite of', 'due to', 'although'],
    explanation:
      '空所の後は節（a critical audit finding was made public）なので接続詞becauseが正しい。in spite of/due toは名詞句が必要な前置詞、althoughは意味が逆で合わない。',
    translation: '重大な監査結果が公になったため、その部署は手続きを見直した。',
    difficulty: 4,
  },
  {
    keyVocabWord: 'termination',
    tags: ['接続詞vs前置詞'],
    question: 'The tenant moved to a new unit ___ the lease reached termination.',
    correctText: 'because',
    distractors: ['notwithstanding', 'because of', 'unless'],
    explanation:
      '空所の後は節（the lease reached termination）なので接続詞becauseが正しい。notwithstanding/because ofは名詞句が必要な前置詞、unlessは条件で文意に合わない。',
    translation: 'リース契約が終了に達したため、その賃借人は新しいユニットへ引っ越した。',
    difficulty: 3,
  },
  ...
  },
  {
    ...
    distractors: ['high', 'highest', 'highly'],
    explanation:
      '"___ than"の形は比較級が正しい。lowerが正しい。high（原級）・highest（最上級）はいずれも比較級ではなく、highlyは副詞で、いずれも合わない。',
