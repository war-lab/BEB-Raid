...
export const PART5_ENTRIES_S2_RAW: Part5RawEntry[] = [
  ...
  {
    keyVocabWord: 'modernize',
    tags: ['動詞の形'],
    question: 'The company had no choice but to ___ its aging equipment.',
    correctText: 'modernize',
    distractors: ['modernized', 'modernizing', 'modernizes'],
    explanation:
      'to不定詞の後は動詞の原形が続くため、modernizeが正しい。他の3つは活用形で、to不定詞の形に合わない。',
    translation: 'その会社は老朽化した設備を近代化せざるを得なかった。',
    difficulty: 3,
  },
  {
  ...
  },
  {
    ...
    tags: ['代名詞・関係詞'],
    question: 'The technician ___ repaired the printer left detailed notes for the next visit.',
    correctText: 'who',
    distractors: ['which', 'whose', 'whoever'],
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞repairedが続く）。whomは目的格、whoseは所有格、whichは物を指し、人物の主格には使えない。',
    translation: 'プリンターを修理した技術者は、次回の訪問のために詳しいメモを残した。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'employee',
    tags: ['代名詞・関係詞'],
    question: 'The employee ___ the committee praised received a bonus.',
    correctText: 'whom',
    distractors: ['which', 'when', 'whoever'],
    explanation:
      '目的格の関係代名詞whom（口語ではwhoも可）が正しい（the committee praisedのpraisedの目的語）。whoseは所有格、whichは物を指す、whereは関係副詞で、いずれも合わない。',
    translation: '委員会が称賛した従業員はボーナスを受け取った。',
    difficulty: 4,
  },
  {
  ...
  },
  {
    ...
    tags: ['接続詞vs前置詞'],
    question: 'The manager was reassigned ___ evidence of poor oversight.',
    correctText: 'because of',
    ...
    translation: '管理不足の証拠のため、そのマネージャーは配置転換された。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'relocation',
    tags: ['接続詞vs前置詞'],
    question: 'The merger was delayed ___ the headquarters relocation.',
    correctText: 'due to',
    distractors: ['in spite of', 'as', 'unless'],
    explanation:
      '空所の後は名詞句（the headquarters relocation）なので前置詞due toが正しい。because/although/unlessは後ろに節が必要な接続詞で、名詞句には合わない。',
    translation: '本社の移転のため、その合併は延期された。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'growth',
    tags: ['接続詞vs前置詞'],
    question: 'The bank raised the credit limit ___ the company showed strong growth.',
    correctText: 'because',
    distractors: ['because of', 'owing to', 'unless'],
    explanation:
      '空所の後は節（the company showed...）なので接続詞becauseが正しい。because of/due toは名詞句が必要な前置詞、despiteは意味が逆で合わない。',
    translation: 'その会社が力強い成長を示したため、銀行は融資限度額を上げた。',
    difficulty: 4,
  },
  {
    keyVocabWord: 'modernization',
    tags: ['接続詞vs前置詞'],
    question: 'The factory increased output ___ it completed a major modernization.',
    correctText: 'because',
    distractors: ['despite', 'on account of', 'even though'],
    explanation:
      '空所の後は節（it completed...）なので接続詞becauseが正しい。because of/due toは名詞句が必要な前置詞、despiteは意味が逆で合わない。',
    translation: '大規模な近代化を完了したため、その工場は生産量を増やした。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'investment',
    tags: ['接続詞vs前置詞'],
    question: 'The startup expanded quickly ___ a major investment from a venture fund.',
    correctText: 'because of',
    distractors: ['despite', 'since', 'unless'],
    explanation:
      '空所の後は名詞句（a major investment...）なので前置詞because ofが正しい。because/although/unlessは後ろに節が必要な接続詞で、名詞句には合わない。',
    translation: 'ベンチャーファンドからの大きな投資のため、そのスタートアップは急速に拡大した。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'defect',
    tags: ['接続詞vs前置詞'],
    question: 'The company recalled the product ___ a manufacturing defect.',
    correctText: 'due to',
    ...
    translation: '製造上の欠陥のため、その会社は製品を回収した。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'audit',
