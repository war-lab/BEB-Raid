...
export const PART5_ENTRIES_S2_RAW: Part5RawEntry[] = [
  ...
  },
  {
    ...
    explanation:
      '主格の関係代名詞whoが正しい（後ろに動詞filedが続く）。whichは物を指し、whoseは所有格、whoeverは不特定の人物を指す語で特定のplaintiffを指す先行詞には合わない。',
  ...
  },
  {
    ...
    distractors: ['which', 'when', 'whoever'],
    explanation:
      '目的格の関係代名詞whom（口語ではwhoも可）が正しい（the jury acquittedのacquittedの目的語）。whichは物を指し、whenは関係副詞、whoeverは不特定の人物を指す語で、いずれも合わない。',
  ...
  },
  {
    ...
    explanation:
      '空所の後は節（the company faced...）なので接続詞becauseが正しい。because of/owing toは名詞句が必要な前置詞、unlessは条件で文意に合わない。',
  ...
  },
  {
    ...
    explanation:
      '空所の後は節（it filed for bankruptcy）なので接続詞becauseが正しい。on account ofは名詞句が必要な前置詞、despite/even thoughは意味が逆で合わない。',
  ...
  },
  {
    ...
    explanation:
      "空所の後は名詞句（the bank's foreclosure）なので前置詞because ofが正しい。despiteは意味が逆で文意が反転する。since/unlessは後ろに節が必要な接続詞で、名詞句には合わない。",
