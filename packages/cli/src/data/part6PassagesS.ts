...
export const PART6_ENTRIES_S: Part6RawEntry[] = [
  ...
  },
  {
    ...
    passageTranslation:
      '件名: 年次セールスカンファレンス — 登録のリマインダー\n\n参加者の皆様へ\n\n年次セールスカンファレンスの登録は今週金曜日で締め切りとなりますので、リマインダーとしてお知らせします。空港近くにある会議会場では30分おきにシャトルサービスが利用できます。登録すると、セッション時間と会場番号が書かれた全日程表を受け取ります。既に登録済みの方は、食事の希望が最新であるか再確認してください。締切後の登録は、いかなる事情でも受け付けられません。当日お会いできることを楽しみにしております。',
    subQuestions: [
      {
        kind: 'grammar',
        correctText: 'which',
