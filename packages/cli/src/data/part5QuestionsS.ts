...
export const PART5_ENTRIES_S: Part5Entry[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { key: 'B', text: 'authorizing' },
      { key: 'C', text: 'authorize' },
      { key: 'D', text: 'authorized' },
    ],
    answer: 'D',
    explanation:
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'finalizing' },
      { key: 'B', text: 'finalize' },
      { key: 'C', text: 'finalization' },
      { key: 'D', text: 'finalized' },
    ],
    answer: 'B',
    explanation:
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'supervising' },
      { key: 'B', text: 'supervise' },
      { key: 'C', text: 'supervision' },
      { key: 'D', text: 'supervised' },
    ],
    answer: 'B',
    explanation:
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'recruitment' },
      { key: 'B', text: 'recruited' },
      { key: 'C', text: 'recruit' },
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'requested' },
      { key: 'B', text: 'request' },
      { key: 'C', text: 'requestable' },
      { key: 'D', text: 'requesting' },
    ],
    answer: 'B',
    explanation:
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'warranting' },
      { key: 'B', text: 'warrant' },
      { key: 'C', text: 'warranty' },
      { key: 'D', text: 'warranted' },
    ],
    answer: 'C',
    explanation:
  ...
  },
  {
    ...
    choices: [
      ...
      { key: 'B', text: 'projected' },
      { key: 'C', text: 'projecting' },
      { key: 'D', text: 'project' },
    ],
    answer: 'A',
    explanation:
  ...
  },
  {
    ...
    choices: [
      ...
      { key: 'B', text: 'corresponded' },
      { key: 'C', text: 'corresponding' },
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'qualify' },
      { key: 'B', text: 'qualified' },
      { key: 'C', text: 'quality' },
      { key: 'D', text: 'qualities' },
    ],
    answer: 'C',
    explanation:
