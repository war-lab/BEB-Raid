...
export const KEY_VOCAB_SIMILAR_ENTRIES: KeyVocabSimilarEntry[] = [
  ...
  },
  {
    ...
    answer: 'A',
    explanation:
      '筆記試験を受けるのはcandidate（候補者）。inspection（検査）・endorsement（推薦）・subscription（購読）は試験を受ける主体になれない。',
  ...
  },
  {
    ...
    choices: [
      ...
      { key: 'B', text: 'inspections' },
      { key: 'C', text: 'candidates' },
      { key: 'D', text: 'proposals' },
    ],
    answer: 'C',
    explanation:
  ...
  },
  {
    word: 'negotiate',
    tags: ['頻出動詞'],
    question: 'The lawyers were able to ___ a fair settlement for both sides.',
    choices: [
    ...
    answer: 'A',
    explanation:
      '公正な和解を導き出すのはnegotiate（交渉する）。inspect（検査する）・subscribe（購読する）・certify（認定する）は和解を成立させる行為にならない。',
    translation: '弁護士たちは両者にとって公正な和解を交渉することができた。',
    difficulty: 2,
  },
  {
    word: 'negotiate',
  ...
  },
  {
    ...
    choices: [
      ...
      { key: 'B', text: 'inspections' },
      { key: 'C', text: 'subscriptions' },
      { key: 'D', text: 'extensions' },
    ],
    answer: 'A',
    explanation:
  ...
  },
  {
    ...
    choices: [
      { key: 'A', text: 'liabilities' },
      { key: 'B', text: 'proposals' },
      { key: 'C', text: 'accounts' },
      { key: 'D', text: 'promotions' },
    ],
    answer: 'D',
    explanation:
