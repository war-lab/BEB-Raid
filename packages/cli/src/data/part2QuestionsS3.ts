...
export const PART2_ENTRIES_S3_RAW: readonly Part2RawEntry[] = [
  // ============ 平叙文＋間接応答（22問） ============
  {
    ...
    explanation:
      '間接応答: 予算超過という発言に対し「新規採用を延期しよう」と対策を提案しており、話の流れに合う。他の2つ（"The budget was approved last week."／"I don\'t have a calculator with me."）は発言内容と噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 明日検査があるという発言を受け「今日中に保管場所を片付けるべきだ」と準備行動を示しており、話の流れに合う。他の2つ（"The inspector left already."／"We passed the inspection last year."）は時系列や話題が合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 会場が予約を取り消したという問題に対し「すぐに連絡できる代替会場を知っている」と解決策を示しており、話の流れに合う。他の2つ（"I already sent the invitations."／"The conference starts at nine."）は問題への対応になっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 迅速な対応を求める発言に対し「チームが今日発送できるか確認する」と行動を示しており、話の流れに合う。他の2つ（"The order was placed last Monday."／"The client canceled the order."）は要望への対応になっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 請求書が未着という発言に対し「事務所に電話して確認する」と対応を示しており、話の流れに合う。他の2つ（"The printer is out of toner again."／"The invoice was for the annual report."）は発話中の語に関連するが、質問の核心への対応にはなっていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 修理の見通しが遅れ続けているという発言に対し「買い替えたほうがいい」と結論を示しており、話の流れに合う。他の2つ（"The repair takes about two weeks."／"I already reported it to IT."）は発言内容と矛盾または噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 立替金がまだ支払われていないという発言に対し「代わりに経理に確認する」と対応しており、話の流れに合う。他の2つ（"The trip was to the branch office."／"I submitted my receipts too."）は発言への直接の対応になっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 推薦契約が破談になったという発言に対し「金曜までに新しい方向性が必要になる」と対応を示しており、話の流れに合う。他の2つ（"The campaign launched last spring."／"She has quite a large following."）は発言と矛盾または的外れ。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: プロジェクターが故障したという発言に対し「念のためスペアを持ってきた」と解決策を示しており、話の流れに合う。他の2つ（"The presentation went well overall."／"The projector is quite old."）は対応として的外れ。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 次の目標達成が早まるという期待に対し「実際に動くのを見てから信じる」と懐疑的な態度を示しており、話の流れに合う。他の2つ（"The approval process takes five steps."／"The software costs quite a lot."）は発言内容と噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 月曜日に新人研修が始まるという発言に対し「それまでに机の準備をしておく」と対応を示しており、話の流れに合う。他の2つ（"Both candidates have strong resumes."／"The interview process took two months."）は発言への対応になっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 予約超過という発言に対し「近くの別のホテルを探す必要がある」と対応を示しており、話の流れに合う。他の2つ（"The conference has three hundred guests."／"The reservation was made months ago."）は対応として的外れ。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 会計上の「のれん」が増えたという発言に対し「来年再評価が必要になる」と実務的な見通しを示しており、話の流れに合う。他の2つ（"The valuation seems too high already."／"The merger closed in March."）は発言内容と噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 合意に至らなかったという発言に対し「今回は投票で決めよう」と解決策を示しており、話の流れに合う。他の2つ（"The meeting ran an hour late."／"The logo was designed last month."）は発言への対応になっていない。',
    translation:
  ...
  // ============ 付加疑問（21問） ============
  {
    ...
    explanation:
      '間接応答: 「検査されていないですよね」という付加疑問に対し「実は3月に消防署の検査があった」と訂正情報で応じており、話の流れに合う。他の2つ（"The office opened in 2019."／"It has three loading docks."）は質問の核心（検査の有無）に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「バッジが必要ですよね」という付加疑問に対し「5時以降だけ必要」と条件付きで応じており、話の流れに合う。他の2つ（"The premises cover two city blocks."／"The badges are printed in the lobby."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「予定通り終えましたよね」という付加疑問に対し「実は1週間早く終えた」と補足情報で応じており、話の流れに合う。他の2つ（"The remodeling cost more than expected."／"The client is based downtown."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「毎年更新が必要ですよね」という付加疑問に対し「以前はそうだったが今は2年ごとだ」と訂正しており、話の流れに合う。他の2つ（"The airport is about ten miles away."／"The shuttle seats about twenty people."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「もう送りましたよね」という付加疑問に対し「実はちょうど送るところだった」とまだ送っていないことを示しており、話の流れに合う。他の2つ（"The client travels frequently."／"The market report covers three regions."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「まだ試用期間中ですよね」という付加疑問に対し「実は先週すでに審査を通過した」と訂正しており、話の流れに合う。他の2つ（"She started three months ago."／"Probation usually lasts ninety days."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「商業用に区分されていますよね」という付加疑問に対し「前半分だけで、裏は住宅用のまま」と部分的な訂正で応じており、話の流れに合う。他の2つ（"Zoning changes take months to approve."／"The lot is about two acres."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「昨年も同じ会社が協賛しましたよね」という付加疑問に対し「いいえ、全く別の協賛企業だった」と訂正しており、話の流れに合う。他の2つ（"The event drew a large crowd."／"Sponsorship fees went up this year."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「まだ欠員がありますよね」という付加疑問に対し「実は先週金曜に補充した」と訂正しており、話の流れに合う。他の2つ（"Accounting has six team members."／"The vacancy was posted online."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「更新時に割引がありますよね」という付加疑問に対し「有効期限前に更新した場合のみ」と条件付きで応じており、話の流れに合う。他の2つ（"Membership fees increased slightly."／"The discount used to be higher."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「初日に研修マニュアルを受け取りますよね」という付加疑問に対し「実は初週全体に分けて行う」と訂正しており、話の流れに合う。他の2つ（"The manual covers company policy."／"New hires meet their supervisors too."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「昨日通関しましたよね」という付加疑問に対し「まだ港で保留されている」と訂正しており、話の流れに合う。他の2つ（"There\'s a container ship at the port."／"The consignee signed for the shipment."）は質問の核心（通関の有無）に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「今年増えましたよね」という付加疑問に対し「いいえ、全く変わらなかった」と訂正しており、話の流れに合う。他の2つ（"The design team works on branding."／"Headcount reports come out quarterly."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「全出展者が入口近くのブースを得ますよね」という付加疑問に対し「6月前に登録した出展者だけ」と条件付きで応じており、話の流れに合う。他の2つ（"The entrance is near the main hall."／"Booths are set up the night before."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「地域で最安値ですよね」という付加疑問に対し「以前はそうだったが先月新しい業者がさらに安くした」と変化を伝えており、話の流れに合う。他の2つ（"Prices tend to rise every winter."／"The wholesaler supplies most local shops."）は質問の核心に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「日帰り旅行を含めるか基調講演だけにするか」という選択疑問に対し「それは顧客に決めてもらう」と判断を委ねる形で答えており、話の流れに合う。他の2つ（"Day trips require an early start."／"The keynote session runs three hours."）はどちらかを直接選んでいる。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「正午か1時のどちらでメニューを確定するか」という選択疑問に対し「来賓講演者の予定に合わせる」と別の基準に委ねる形で答えており、話の流れに合う。他の2つ（"The caterer needs two days notice."／"Lunch usually runs an hour."）はどちらかを直接選んでいない代わりに関係ない情報。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「顧客対応を外部委託するか社内で続けるか」という選択疑問に対し「まず1つの製品ラインで試験導入しよう」と条件付きの折衷案を示しており、話の流れに合う。他の2つ（"In-house support tends to cost more."／"Customer satisfaction scores dropped recently."）はどちらかを直接選んでいない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「会社全体をリブランドするかロゴだけ更新するか」という選択疑問に対し「小さく始めて反応を見よう」と暗にロゴ更新を選ぶ形で答えており、話の流れに合う。他の2つ（"Rebranding usually takes a full year."／"The current logo is ten years old."）は選択の判断につながっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「今回は航空便か海運かどちらで発送するか」という選択疑問に対し「顧客が1週間以内に必要なので航空便」と理由を添えて選んでおり、話の流れに合う。他の2つ（"Sea carriers are cheaper per container."／"The shipment weighs about two tons."）は選択の根拠を示していない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「下請け業者を入れるか現場の勤務時間を延長するか」という選択疑問に対し「延長の方が安いかもしれないが残業規定を先に確認しよう」と条件付きで答えており、話の流れに合う。他の2つ（"The current crew has ten workers."／"The subcontractor is available next week."）は判断につながっていない。',
    translation:
      '下請け業者を入れるべきですか、それとも今の作業員の勤務時間を延長すべきですか？ — 延長の方が安いかもしれませんが、まず残業規定を確認しましょう。',
    difficulty: 4,
  },
  {
    keyVocabWord: 'replenishment',
    tags: ['選択疑問'],
    script:
      'Should replenishment happen before opening or after closing? — Mornings work better, since the delivery arrives at six.',
    correctText: 'Mornings work better, since the delivery arrives at six.',
    distractors: [
      'The stockroom takes up a lot of space.',
      'Replenishment usually takes about an hour.',
    ],
    explanation:
      '間接応答: 「補充は開店前か閉店後か」という選択疑問に対し「配送が6時に届くので朝の方がよい」と理由を添えて開店前を選んでおり、話の流れに合う。他の2つ（"The stockroom takes up a lot of space."／"Replenishment usually takes about an hour."）は在庫置き場の広さ・所要時間の話で、どちらも選択の根拠になっていない。',
    translation:
      '補充は開店前にすべきですか、それとも閉店後ですか？ — 配送が6時に届くので、朝の方がやりやすいです。',
    difficulty: 4,
  },
  {
    ...
    explanation:
      '間接応答: 「ショールームで見るかまずオンラインで見るか」という選択疑問に対し「まずオンラインで見て、実際に確認すべき点を把握したい」と理由を添えて選んでおり、話の流れに合う。他の2つ（"The new models launched last week."／"The showroom is open until eight."）は選択の根拠を示していない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「今すぐ人員を増やすか来期まで待つか」という選択疑問に対し「今のプロジェクトの様子を見てから決めよう」と暗に待つ方を選んでおり、話の流れに合う。他の2つ（"Hiring now would cost more overall."／"Overhead grew last year too."）は選択への直接の回答になっていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「オンライン小売業者か実店舗チェーンのどちらと提携するか」という選択疑問に対し「条件が合理的なら両方」と両方を示す形で答えており、話の流れに合う。他の2つ（"The online retailer ships internationally."／"The chain has locations nationwide."）はどちらかを直接選んでいない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「1年間の契約更新か短期契約の交渉か」という選択疑問に対し「短期契約にして選択肢を残したい」と理由を添えて選んでおり、話の流れに合う。他の2つ（"The current agreement expires in June."／"Rent went up slightly this year."）は選択の根拠を示していない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「問い合わせに電話かメールのどちらで返答するか」という選択疑問に対し「記録が残るのでメール」と理由を添えて選んでおり、話の流れに合う。他の2つ（"Phone calls tend to be faster."／"The request came in this morning."）は選択の根拠を示していない。',
    translation:
