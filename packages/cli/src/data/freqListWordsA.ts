...
const HR_TRAINING: Entry[] = [
  ...
  { word: 'dismiss', rationale: '解雇する' },
  { word: 'dismissal', rationale: '解雇（名詞）' },
  { word: 'layoff', rationale: '一時解雇・人員整理' },
  { word: 'severance', rationale: '退職金・解雇手当' },
...
const FINANCE_CONTRACT: Entry[] = [
  ...
  { word: 'arrears', rationale: '未払い金・延滞' },
...
const LEGAL_ENV: Entry[] = [
  ...
  { word: 'litigation', rationale: '訴訟' },
  { word: 'lawsuit', rationale: '訴訟（個別の）' },
  { word: 'plaintiff', rationale: '原告' },
  { word: 'defendant', rationale: '被告' },
  { word: 'jurisdiction', rationale: '管轄権' },
  { word: 'statute', rationale: '法令・制定法' },
  { word: 'infringe', rationale: '（権利を）侵害する' },
  { word: 'infringement', rationale: '侵害（名詞）' },
