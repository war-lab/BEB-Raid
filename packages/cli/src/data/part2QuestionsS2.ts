...
export const PART2_ENTRIES_S2_RAW: Part2RawEntry[] = [
  ...
  // --- 数字・時刻 ---
  {
    ...
    explanation:
      '時刻を尋ねる質問には具体的な時間で答える。他の2つ（"In conference room B."／"The regional managers."）は場所・人物の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '数量を尋ねる質問には具体的な人数で答える。他の2つ（"Because business is growing."／"Mostly in the sales division."）は部門・理由の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '期間を尋ねる質問には具体的な日数で答える。他の2つ（"Because of a missing form."／"The shipping company."）は理由・主体の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '割合を尋ねる質問には数値で答える。他の2つ（"Small manufacturing firms."／"Once a year, in March."）は対象・時期の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '時を尋ねる質問には具体的な日付で答える。他の2つ（"On rental properties only."／"The city council decided."）は主体・対象の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '増加量を尋ねる質問には数値で答える。他の2つ（"Since last spring."／"The production manager."）は時期・人物の応答で噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '割合を尋ねる質問には数値で答える。他の2つ（"Since it opened in June."／"The property management firm."）は時期・主体の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '増加量を尋ねる質問には数値で答える。他の2つ（"The chief financial officer."／"Because of tighter budgeting."）は人物・理由の応答で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '増加量を尋ねる質問には数値で答える。他の2つ（"Since early spring."／"The mall management office."）は時期・主体の応答で噛み合わない。',
    translation: '改装後、来店客数はどれくらい増えましたか？ — 週末はおよそ20パーセントです。',
    difficulty: 3,
  },
  {
    keyVocabWord: 'apprenticeship',
    tags: ['数字・時刻'],
    script: 'How long is the apprenticeship program? — Around two years in total.',
    correctText: 'Around two years in total.',
    distractors: ['The human resources director.', 'Mainly younger employees.'],
    explanation:
      '期間を尋ねる質問には長さで答える。他の2つ（"The human resources director."／"Mainly younger employees."）は人物・対象の応答で、いずれも期間を答えていない。',
    translation: '実習生制度はどれくらいの長さですか？ — 合計でおよそ2年です。',
    difficulty: 3,
  },
  ...
  },
  {
    ...
    explanation:
      '依頼（Could you...?）への応答は対応の意思表示。他の2つ（"The order number is 4521."／"It arrived on time last week."）は過去の実績や番号情報で、依頼への直接的な返答になっていない。',
  ...
  },
  {
    ...
    explanation:
      '進捗を尋ねる質問（Did you...?）には状況で答える。他の2つ（"The finance team handles that."／"It was due last Friday."）は主体や期限の情報で、進捗を尋ねる質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      '意図を尋ねる質問（Going to...?）には計画の有無で答える。他の2つ（"It took three weeks last time."／"The operations team suggested it."）は過去の所要時間や提案者の情報で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '提案（Should we...?）への応答は賛成・反対の意見。他の2つ（"About two hundred people signed up."／"The marketing team is in charge."）は人数や担当者の情報で、提案への返答になっていない。',
  ...
  },
  {
    ...
    explanation:
      '時を尋ねる質問（Do you know when...?）には具体的な日で答える。他の2つ（"It usually takes an hour."／"Your manager conducted it."）は主体・所要時間の情報で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '勧誘（Want to...?）への応答は同意か辞退。他の2つ（"They improved last quarter."／"The HR analyst prepared them."）は実績や作成者の情報で、勧誘への返答になっていない。',
  ...
  },
  {
    ...
    explanation:
      '意図を尋ねる質問（Going to...?）には計画の状況で答える。他の2つ（"The software vendor called yesterday."／"It saved us a lot of time."）は過去の効果や連絡の情報で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      '提案（Should...?）への応答は意見・根拠。他の2つ（"It grew by ten percent last year."／"The meeting is at noon."）は実績や時刻の情報で、提案への返答になっていない。',
    translation:
  ...
  // --- 米英アクセント（発話者の言い回しの違いに注意する想定の対話） ---
  {
    ...
    explanation:
      'What（何）への応答は内容。他の2つ（"It opened last spring."／"The property developer."）は時期・主体の応答で、施設内容を尋ねる質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'Who（誰）への応答は人物・窓口。他の2つ（"It opens at six."／"The hotel has three restaurants."）は営業時間や施設数の情報で、Whoの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"It seats forty people."／"The travel agency arranged it."）は定員・手配者の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Yes/No疑問文には賛否で答える。他の2つ（"They deliver twice a day."／"The warehouse is downtown."）は頻度・場所の情報で、Yes/No疑問文への直接応答になっていない。',
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"It was built ten years ago."／"The airline added new routes."）は建設時期・追加路線の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'What（何）への応答は内容。他の2つ（"It has two hundred rooms."／"It was renovated last year."）は客室数・改装時期の情報で、Whatの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'How long（どのくらい）への応答は所要時間。他の2つ（"It’s near the harbor."／"I started last month."）は場所・開始時期の情報で、How longの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The city added a new lane."／"It happens every Friday."）は頻度・道路改良の情報で、Whyの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'How long（どのくらい）は程度・長さを尋ねる。他の2つ（"It closes at midnight."／"Two officers were on duty."）は人員数・営業時間の情報で、質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"It leaves at midnight."／"The airline is based overseas."）は出発時刻・拠点の情報で、Whyの質問には合わない。',
  ...
  // --- 間接応答（difficulty4。素直な語り口対応でなく推論を要する応答） ---
  {
    ...
    explanation:
      '間接応答: 「今日の午後また会議がある」は「まだ承認していない（結果待ち）」ことを暗に示す。他の2つ（"It was signed last year."／"The lawyers drafted it."）は直接的だが文脈に合わない情報。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「これまでは要約のみ公開された」は「全文はまだ開示されていない」ことを示す。他の2つ（"The CFO wrote it."／"The cafeteria is closed for renovation."）は直接的だが質問の核心（開示の有無）に答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「まだ口座を確認していない」は「分からない・まだ確認できていない」ことを示す間接的な回答。他の2つ（"The parking garage is full today."／"The finance office is on the second floor."）は質問の核心に答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「技術者がちょうど帰ったところ」は「（今なら）直っているはず」であることを暗に伝える。他の2つ（"It broke down twice."／"The warranty covers repairs."）は質問（直っているか）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「今カレンダーを確認する」は「今のところ分からない、確認して答える」という保留の返答。他の2つ（"It seats twenty people."／"The marketing team reserved it."）は質問（重複予約か）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「次の四半期報告の後にもっと分かる」は「まだ確定的には言えない」ことを示す間接的な回答。他の2つ（"It launched in March."／"The design team is in Chicago."）は質問（収益性が改善したか）に直接答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「最終的な数字はまだ出ていない」は「まだ分からない」ことを暗に示す。他の2つ（"It was founded ten years ago."／"The CEO gave a speech last week."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「来週アップデートを配信する予定」は「まだ完全に旧式ではない、対応中」であることを示す。他の2つ（"The IT team installed it."／"The manual is on the intranet."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「金曜にまた会議がある」は「まだ決まっていない」ことを示す。他の2つ（"The office is on the fifth floor."／"The proposal was ten pages long."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「認証はまだ保留中」は「まだ正式には基準を満たしたと確認されていない」ことを示す。他の2つ（"It opened last spring."／"The manager toured it yesterday."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「まだ複数の建物を比較検討中」は「まだ確定していない」ことを示す。他の2つ（"It was built in 1998."／"The parking lot is quite small."）は質問（移転が確定したか）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「明日また検査員が来て判断する」は「まだ正式決定していない」ことを示す。他の2つ（"It was built in the 1950s."／"The tenants moved out already."）は質問（許可証が発行されたか）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「予想はついていた（saw it coming）」は「驚きではなかった」ことを示す。他の2つ（"It was filed last Tuesday."／"The manager reviewed it already."）は質問（驚きだったか）に直接答えていない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「判断するにはまだ早すぎる」は「まだ分からない」ことを示す。他の2つ（"The plan was announced in April."／"The consultant flew in from Boston."）は質問（うまくいっているか）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「本社からの連絡待ち」は「まだ確定していない」ことを示す。他の2つ（"It affects the sales team."／"It was announced in May."）は質問（計画が確定したか）に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「規約を確認してみる」は「今すぐには断言できない」という保留の返答。他の2つ（"It costs two hundred dollars."／"The flight leaves at noon."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「次の議会まで分からない」は「まだ承認されたか不明」であることを示す。他の2つ（"The architect submitted the plans."／"The property is near the river."）は質問に直接答えていない。',
  ...
  },
  {
    ...
    explanation:
      '間接応答: 「まだ情報を集めている最中」は「まだ完了していない」ことを示す。他の2つ（"It was submitted last week."／"The customer called twice."）は質問（問い合わせ対応が完了したか）に直接答えていない。',
  ...
  // --- 追加の直接応答（数字・時刻／疑問詞・弱形バランス調整） ---
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The sales rep is based abroad."／"It launched last year."）は時期・人物情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'What（何）への応答は内容。他の2つ（"The IT team manages it."／"It was installed last month."）は時期・主体の応答で、Whatの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Who（誰）への応答は人物。他の2つ（"It was updated last week."／"Because of a licensing issue."）は時期・理由の応答で、Whoの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The IT director."／"It takes effect next Monday."）は主体・時期の応答で、Whyの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      '数量を尋ねる質問には数値で答える。他の2つ（"It takes ten minutes each."／"The IT team scheduled it."）は所要時間・主体の応答で噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Where（どこ）への応答は場所。他の2つ（"The security team manages it."／"It was installed last year."）は時期・主体の応答で、Whereの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'How long（どのくらい）への応答は所要時間。他の2つ（"It used to be much slower."／"The cloud team handles it."）は主体・過去との比較で、質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The IT director."／"A year."）は期間・提案者の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'When（いつ）への応答は時。他の2つ（"About two hundred clients use it."／"The development team built it."）は数量・主体の情報で、Whenの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      '金額・程度を尋ねる質問には数値で答える。他の2つ（"The board approved it in March."／"It’s managed by an outside firm."）は時期・主体の情報で噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'What（何を）への応答は取るべき行動。他の2つ（"It happened last Tuesday."／"The finance department was targeted."）は時期・標的の情報で、質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The supplier is based locally."／"They were delivered last week."）は配達時期・仕入先の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Who（誰）への応答は人物。他の2つ（"It was formed two years ago."／"It focuses on renewable energy."）は設立時期・分野の情報で、Whoの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'How（どのように）への応答は方法・関係性。他の2つ（"It was released in June."／"The design team built it."）は時期・主体の情報で、Howの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Who（誰）への応答は人物。他の2つ（"It took about a week."／"It highlights sales growth."）は所要時間・内容の情報で、Whoの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"It was implemented last year."／"The operations manager led it."）は時期・主体の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Where（どこ）への応答は場所。他の2つ（"It starts at nine."／"About twenty employees will attend."）は時刻・人数の情報で、Whereの質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      '比較・程度を尋ねる質問には数値で答える。他の2つ（"A consulting firm prepared it."／"The report came out last week."）は時期・主体の情報で噛み合わない。',
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The CEO used to work in finance."／"It was founded three years ago."）は設立時期・経歴の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Where（どこ）への応答は場所。他の2つ（"It launched two years ago."／"The marketing team wrote the copy."）は時期・主体の情報で、Whereの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'What kind（どんな種類）への応答は内容。他の2つ（"It opened five years ago."／"The chef trained in Paris."）は開業時期・経歴の情報で、質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '割合を尋ねる質問には数値で答える。他の2つ（"We signed them last spring."／"The partnerships team manages them."）は時期・主体の情報で噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '増加量を尋ねる質問には数値で答える。他の2つ（"The update took six months to build."／"The design team led the project."）は開発期間・主体の情報で噛み合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Why（なぜ）への応答は理由。他の2つ（"The campaign launched last week."／"The agency is based overseas."）は開始時期・所在地の情報で、Whyの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '方法を尋ねる質問には手段で答える。他の2つ（"It increased sales last quarter."／"The store manager suggested it."）は結果・提案者の情報で、Howの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '方法を尋ねる質問には手段で答える。他の2つ（"The customer bought it online."／"The complaint came in yesterday."）は時期・購入経路の情報で、Howの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '速さ・時間を尋ねる質問には期間で答える。他の2つ（"The customer called twice."／"The finance team was notified."）は行動・通知先の情報で、質問には合わない。',
  ...
  },
  {
    ...
    explanation:
      'How（どのように）への応答は方法。他の2つ（"It was founded downtown."／"The CEO grew up nearby."）は設立場所・経歴の情報で、Howの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      'Who（誰）への応答は人物・役職。他の2つ（"It happened last month."／"Both departments are on the same floor."）は時期・場所の情報で、Whoの質問には合わない。',
    translation:
  ...
  },
  {
    ...
    explanation:
      '方法を尋ねる質問には手段で答える。他の2つ（"The logistics director proposed it."／"It happened after a shortage."）は経緯・提案者の情報で、Howの質問には合わない。',
    translation:
